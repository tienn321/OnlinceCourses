            ...
            <div className="contact_form">
              ...
              <div className="contact_form_container">
                <form action="post">
                  ...
                  <textarea id="contact_form_message" className="text_field contact_form_message" name="message" placeholder="Message" required="required" data-error="Please, write us a message." defaultValue={""} />
